...
#include "../display.h"
struct linked_list_value *linked_list_dsp_pkt_value_init(void (*func)(FILE *, struct protocol_header *, struct protocol_header *, struct protocol_header *, struct data *));
void linked_list_dsp_pkt_value_free(struct linked_list_value *);
struct linked_list_value *linked_list_dsp_rpt_value_init(void (*func_dsp)(FILE *, __u8 *), __u8 *val, unsigned int size);
